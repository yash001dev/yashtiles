...
const FrameItPhotoGallery = dynamic(() => import("@/components/dashboard/FrameItPhotoGallery"), {
...
const FrameItTestimonialsSlider = dynamic(() => import("@/components/dashboard/FrameItTestimonialsSlider"), {
...
const FrameItFeatures = dynamic(() => import("@/components/dashboard/FrameItFeatures"), {
  loading: () => <div className="py-20 bg-white"><div className="container mx-auto px-4"><div className="animate-pulse h-96 bg-gray-200 rounded-lg"></div></div></div>,
  ssr: true
});

const FrameItShowcase = dynamic(() => import("@/components/dashboard/FrameItShowcase"), {
...
const FrameItWhatWeCover = dynamic(() => import("@/components/dashboard/FrameItWhatWeCover"), {
  loading: () => <div className="py-20 bg-white"><div className="container mx-auto px-4"><div className="animate-pulse h-96 bg-gray-200 rounded-lg"></div></div></div>,
  ssr: true
});
...
const FrameItFooter = dynamic(() => import("@/components/dashboard/FrameItFooter"), {
