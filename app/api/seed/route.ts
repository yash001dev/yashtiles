...
// Seed data
import { seedSizes, seedMaterials, seedFrameColors, seedHangOptions } from '@/payload/seed/seedData';
...
async function ensureDoc(collection: string, where: any, data: any) {
