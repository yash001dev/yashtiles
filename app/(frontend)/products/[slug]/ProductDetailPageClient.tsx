...
export default function ProductDetailPageClient({initialProduct, slugParam}: {initialProduct: Product, slugParam: string}) {
  const params = useParams();
  const router = useRouter();
  const slug =  slugParam || params.slug as string;
 const product =initialProduct;
  ...
  const getSelectedSizeData = () => {
    ...
    return (
      sizes.find((s) => s.name === sizeName) ||
      product?.availableSizes?.find((s) => s.name === sizeName)
    );
  };
  ...
  const getSelectedVariants = () => {
    ...
    const color = product?.defaultColors
      ?.concat(product?.additionalColors || [])
      .find((c) => c.id === selectedColor);
    const material = product?.defaultMaterials
      ?.concat(product?.additionalMaterials || [])
      .find((m) => m.id === selectedMaterial);
              ...
              <AnimatePresence mode="popLayout">
                ...
                <div className="border-t border-b py-6">
                  <div className="flex items-center gap-4">
                    ...
                    {product.compareAtPrice &&
                      product.compareAtPrice > getCurrentPrice() && (
                        <>
                ...
                <div className="space-y-6">
                  ...
                  {product?.defaultColors &&
                    product.defaultColors.length > 0 && (
                      <div>
                        <h3 className="font-semibold text-gray-900 mb-3">
                          Color:{" "}
                          {product.defaultColors
                        ...
                        <div className="space-y-3">
                          ...
                          {product.additionalColors &&
                            product.additionalColors.length > 0 && (
                              <div>
                                {showAllColors && (
                  ...
                  {product?.defaultMaterials &&
                    product.defaultMaterials.length > 0 && (
                      <div>
                        <h3 className="font-semibold text-gray-900 mb-3">
                          Material:{" "}
                          {product.defaultMaterials
                              ...
                              <div>
                                {showAllMaterials && (
                                  <div className="grid grid-cols-1 md:grid-cols-3 gap-3 mb-3">
                                    {product.additionalMaterials.map(
                                      (material) => (
                                        <button
                                          key={material.id}
                                          onClick={() =>
                    ...
                    <div>
                      ...
                      <div className="flex items-center border border-gray-300 rounded-lg">
                        ...
                        <button
                          onClick={() =>
                            setQuantity(
                              Math.min(getCurrentStock(), quantity + 1)
                            )
                          }
                          className="p-2 hover:bg-gray-50 transition-colors"
                  ...
                  <div className="flex flex-col gap-4">
                    <div className="flex gap-4">
                      <Button
                        ...
                        disabled={
                          !isVariantAvailable() || getCurrentStock() === 0
                        }
                      >
    ...
    <div className="space-y-12">
      {content.map((block, index) => (
        ...
        >
          ...
          {block.blockType === "frame-specifications" && (
            <FrameSpecificationsSection block={block} />
          )}
          {block.blockType === "banner" && <BannerSection block={block} />}
          {block.blockType === "slider" && <SliderSection block={block} />}
          {block.blockType === "custom-html" && (
            <CustomHTMLSection block={block} />
          )}
        </motion.div>
      ))}
    </div>
                      ...
                      <div>
                        ...
                        <div
                          ...
                          dangerouslySetInnerHTML={{
                            __html:
                              block.specifications[activeSpec].description,
                          }}
                        />
                      </div>
                      {block.specifications[activeSpec].images &&
                        block.specifications[activeSpec].images.length > 0 && (
                          <div className="aspect-video rounded-lg overflow-hidden">
                            <img
                              src={
                                block.specifications[activeSpec].images[0].image
                                  .url
                              }
                              alt={
                                block.specifications[activeSpec].images[0]
                                  .caption ||
                                block.specifications[activeSpec].title
                              }
                              className="w-full h-full object-cover"
    ...
    >
      ...
      <div className="relative z-10 container mx-auto px-4">
        ...
        >
          ...
          {block.subtitle && <p className="text-xl mb-6">{block.subtitle}</p>}
          {block.description && (
            <div
                        ...
                        {slide.link?.url && slide.link?.text && (
                          <Button size="lg" asChild>
                            <a
                              href={slide.link.url}
                              target={
                                slide.link.openInNewTab ? "_blank" : "_self"
                              }
                              rel={
