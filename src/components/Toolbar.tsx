    ...
    return (
      <div className="fixed left-0 top-16 h-[calc(100vh-4rem)] w-20 bg-white border-r border-gray-100 z-30 flex flex-col shadow-sm">
        ...
        <div className="flex-1 flex flex-col pt-4 pb-4">
          <div className="flex flex-col space-y-4 px-3">            {tools.map((tool, index) => (
              <button
                key={tool.id}
                ...
                style={{
                  ...
                  animation: hasImage ? 'slideInLeft 0.5s ease-out forwards' : 'none'
                }}
              >
        ...
        </div>        {/* Bottom section with add frame button */}
