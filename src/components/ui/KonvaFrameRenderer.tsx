    ...
    return (
      <div
        ...
        style={{
          width: canvasWidth,
          height: canvasHeight,
          display: downloadOnlyImage ? "none" : undefined,
          position: "relative",
        }}
      >
            ...
            {image && (
              <>
                ...
                {(() => {
                  ...
                  const downloadPadding =
                    customization.material === "classic" ? 4 : 2; // Reduced from 8:4 to 4:2
                  const downloadAvailableWidth =
                    canvasWidth - 2 * downloadPadding;
                  const downloadAvailableHeight =
                    canvasHeight - 2 * downloadPadding;
                  ...
                  if (
                    ...
                    const downloadAreaAspect =
                      downloadAvailableWidth / downloadAvailableHeight;
                    if (imageAspect > downloadAreaAspect) {
                      downloadDisplayHeight = downloadAvailableHeight;
                      downloadDisplayWidth =
                        downloadAvailableHeight * imageAspect;
                      downloadOffsetX =
                        (downloadAvailableWidth - downloadDisplayWidth) / 2;
                    } else {
                      downloadDisplayWidth = downloadAvailableWidth;
                      downloadDisplayHeight =
                        downloadAvailableWidth / imageAspect;
                      downloadOffsetY =
                        (downloadAvailableHeight - downloadDisplayHeight) / 2;
                    }
                  } else {
                    ...
                    <Group
                      ...
                      clipFunc={(ctx) => {
                        ...
                        ctx.rect(
                          0,
                          0,
                          downloadAvailableWidth,
                          downloadAvailableHeight
                        );
                        ctx.closePath();
                      }}
                    >
                      <KonvaImage
                        ...
                        filters={[]}
                        style={{
                          filter: getEffectFilter(customization.effect),
                        }}
                        listening={false}
                        perfectDrawEnabled={false}
                      />
