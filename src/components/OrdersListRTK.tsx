...
interface OrdersListRTKProps {
  onViewOrderDetails?: (orderId: string) => void;
  className?: string;
}

export function OrdersListRTK({ onViewOrderDetails, className = '' }: OrdersListRTKProps) {
  const { orders, meta, loading, error, refetch, setPage, setLimit } = useOrdersRTK();
