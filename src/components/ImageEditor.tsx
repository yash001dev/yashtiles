...
const ImageEditor: React.FC<ImageEditorProps> = ({
  ...
  const getAspectRatio = () => {
    return customization.size === '8x11' ? 'aspect-[8/11]' : 
           customization.size === '11x8' ? 'aspect-[11/8]' : 
           'aspect-square';
  };

  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-90">
      <div className="relative bg-white rounded-2xl shadow-2xl max-w-4xl w-full mx-4 max-h-[95vh] overflow-hidden">
        ...
        <div className="p-6">
          <div className="flex flex-col lg:flex-row gap-6">
            ...
            <div className="flex-1 flex items-center justify-center">
              <div className={`relative ${customization.material === 'classic' ? 'p-6' : ''} ${customization.material === 'classic' ? getFrameColor() : ''} shadow-2xl max-w-sm w-full`}>
                <div 
