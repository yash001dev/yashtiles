    ...
    <div className={`bg-white rounded-xl shadow-lg p-6 ${className}`}>
      ...
      <div className="space-y-6">
        ...
        {frames.map((frame, index) => {
          ...
          return (
            <div key={frame.id} className="border-b border-gray-100 pb-4 last:border-b-0">
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm font-medium text-gray-900">{getMaterialName(frame.customization.material)}</p>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm font-medium text-gray-900">{getColorName(frame.customization.frameColor)}</p>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm font-medium text-gray-900">{frame.customization.size.replace('x', '" X ')}"</p>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm font-medium text-gray-900">{getFinishName(frame.customization.material)}</p>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm font-medium text-gray-900">{getHangType(frame.customization.material)}</p>
                  </div>
                </div>
                
                {/* Frame Price */}
                <div className="flex justify-between items-center pt-2">
                  <span className="text-sm font-medium text-gray-700">Frame {index + 1} Price</span>
                  <span className="text-lg font-bold text-purple-600">₹{framePrice}</span>
                </div>
              </div>
            </div>
          );
      ...
      <div className="mt-6 pt-6 border-t border-gray-200">
        <div className="space-y-3">
          <div className="flex justify-between items-center">
            <span className="text-sm text-gray-600">Items ({frames.length})</span>
