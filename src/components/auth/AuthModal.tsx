      ...
      <div className="space-y-4">
        ...
        <div className="relative">
          ...
          <input
            ...
            onChange={handleInputChange}
            required
            className="w-full pl-10 pr-12 bg-white py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-pink-500 focus:border-pink-500 focus:outline-none transition-all duration-200"
          />
          <button
            type="button"
      ...
      <div className="space-y-4">
        ...
        <div className="relative">
          ...
          <input
            ...
            onChange={handleInputChange}
            required
            className="w-full pl-10 pr-12 py-3 border bg-white border-gray-300 rounded-lg focus:ring-2 focus:ring-pink-500 focus:border-pink-500 focus:outline-none transition-all duration-200"
          />
          <button
            type="button"
            onClick={() => setShowPassword(!showPassword)}
